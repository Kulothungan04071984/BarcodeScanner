...
{
    public partial class FinalBarcode : Form
    {
        ...
        private TextBox txtBarcodeFinal;
        private RichTextBox rtbLog;
        private ListView lvGenerated;

        private Button btnClearFinal;
        private Button btnGenerateNowFinal;
        private Button btnExportFinal;

        private ThemedProgressBarFinal pbScan;
        ...
        private const int SCAN_TARGETFINAL = 10;
        ...
        private void BuildSidebar()
        {
            ...
            lblScanned = BuildStatLabel("SCANNED", "0 / 10", Color.FromArgb(30, 40, 70), C_ACCENT);
            ...
            // Bottom buttons
            btnClearFinal = BuildSidebarButton("⟳  Clear All", 0);
            btnGenerateNowFinal = BuildSidebarButton("⚡  Generate Now", 1);
            btnExportFinal = BuildSidebarButton("↓  Export List", 2);
            ...
            pnlButtons.Controls.Add(btnExportFinal);
            pnlButtons.Controls.Add(btnGenerateNowFinal);
            pnlButtons.Controls.Add(btnClearFinal);
        ...
        private void BuildHeader()
        {
            ...
            {
                Text = "Scan 10 barcodes · Auto-generate ECH codes · Export results",
        ...
        private void BuildInputCard()
        {
            ...
            txtBarcodeFinal.Width = panelInputCard.Width - 40;
            txtBarcodeFinal.Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top;
            ...
            panelInputCard.Controls.Add(txtBarcodeFinal);
        ...
        private void BuildProgressBar()
        {
            ...
            pbScan = new ThemedProgressBarFinal
            {
                Minimum = 0,
                Maximum = SCAN_TARGETFINAL,
                Value = 0,
                Height = 14,
                Anchor = AnchorStyles.Left | AnchorStyles.Right | AnchorStyles.Top,
        ...
        //  EVENTS & LOGIC
        // ═════════════════════════════════════════════════════════
        private void WireEventsFinal()
        {
            txtBarcodeFinal.KeyDown += TxtBarcode_KeyDown;
            txtBarcodeFinal.TextChanged += TxtBarcode_TextChanged;
            btnClearFinal.Click += (s, _) => ClearAll();
            btnGenerateNowFinal.Click += (s, _) => GenerateBarcodes();
            btnExportFinal.Click += (s, _) => ExportList();
            this.Load += (s, _) => txtBarcodeFinal.Focus();
        }
        ...
        private void TxtBarcode_TextChanged(object sender, EventArgs e)
        {
            ...
            if (_autoTimer == null)
            {
                _autoTimer = new System.Windows.Forms.Timer { Interval = 300 };
                _autoTimer.Tick += (s, _) => { _autoTimer.Stop(); AcceptBarcode(); };
            }
            _autoTimer.Stop();
            if (txtBarcodeFinal.Text.Length >= 4)
                _autoTimer.Start();
        }
        ...
        {
            var code = txtBarcodeFinal.Text.Trim();
            ...
            txtBarcodeFinal.Clear();
            txtBarcodeFinal.Focus();

            // Auto-generate when target hit
            if (_scannedBarcodes.Count == SCAN_TARGETFINAL)
                GenerateBarcodes();
        }
        ...
        private void UpdateStats()
        {
            ...
            int cap = Math.Min(cnt, SCAN_TARGETFINAL);

            pbScan.Value = cap;
            lblProgressInfo.Text = $"Progress: {cnt} / {SCAN_TARGETFINAL}";

            lblScanned.Tag = $"{cnt} / {SCAN_TARGETFINAL}";
        ...
        private void GenerateBarcodes()
        {
            ...
            int batches = Math.Max(1, _scannedBarcodes.Count / SCAN_TARGETFINAL);
            ...
            pbScan.Value = 0;
            lblScanned.Tag = "0 / 10";
            lblProgressInfo.Text = "Progress: 0 / 10";
            MessageBox.Show(
    ...
    internal class ThemedProgressBarFinal : ProgressBar
    {
        public ThemedProgressBarFinal()
        {
